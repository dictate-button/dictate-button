...
function Ct(t, e) {
  const n = p, r = y, s = t.length === 0, o = e === void 0 ? r : e, l = s ? nt : {
    owned: null,
    cleanups: null,
...
function st(t, e) {
  ...
  }, r = (s) => (typeof s == "function" && (s = s(n.value)), ot(n, s));
  return [rt.bind(n), r];
}
function R(t, e, n) {
  const r = it(t, e, !1, m);
...
function St(t, e, n) {
  ...
  const r = it(t, e, !0, 0);
  return r.observers = null, r.observerSlots = null, r.comparator = n.equals || void 0, L(r), rt.bind(r);
}
function G(t) {
  if (p === null) return t();
  const e = p;
...
function ot(t, e, n) {
  let r = t.value;
  return (!t.comparator || !t.comparator(r, e)) && (t.value = e, t.observers && t.observers.length && T(() => {
    for (let s = 0; s < t.observers.length; s += 1) {
      const o = t.observers[s], l = V && V.running;
...
function mt(t, e, n) {
  ...
  try {
    ...
    return t.pure && (t.state = m, t.owned && t.owned.forEach(x), t.owned = null), t.updatedAt = n + 1, ut(l);
  } finally {
    p = o, y = s;
  }
  (!t.updatedAt || t.updatedAt <= n) && (t.updatedAt != null && "observers" in t ? ot(t, r) : t.value = r, t.updatedAt = n);
}
function it(t, e, n, r = m, s) {
  const o = {
    fn: t,
    state: r,
    updatedAt: null,
...
function T(t, e) {
  ...
  try {
    ...
    n || (S = null), g = null, ut(r);
  }
}
function vt(t) {
  if (g && (at(g), g = null), t) return;
  const e = S;
  S = null, e.length && T(() => _t(e), !1);
}
function at(t) {
...
function I(t, e) {
  ...
  for (let n = 0; n < t.sources.length; n += 1) {
    ...
    if (r.sources) {
      const s = r.state;
      s === m ? r !== e && (!r.updatedAt || r.updatedAt < F) && lt(r) : s === B && I(r, e);
    }
  }
}
function ct(t) {
...
const P = (t) => St(() => t());
function Et(t, e, n) {
  let r = n.length, s = e.length, o = r, l = 0, i = 0, a = e[s - 1].nextSibling, u = null;
  for (; l < s || i < o; ) {
    if (e[l] === n[i]) {
      l++, i++;
      continue;
    ...
    for (; e[s - 1] === n[o - 1]; )
      s--, o--;
    if (s === l) {
      const f = o < r ? i ? n[i - 1].nextSibling : n[o - i] : a;
      for (; i < o; ) t.insertBefore(n[i++], f);
    } else if (o === i)
      for (; l < s; )
        (!u || !u.has(e[l])) && e[l].remove(), l++;
    else if (e[l] === n[o - 1] && n[i] === e[s - 1]) {
      const f = e[--s].nextSibling;
      t.insertBefore(n[i++], e[l++].nextSibling), t.insertBefore(n[--o], f), e[s] = n[o];
    } else {
      if (!u) {
        u = /* @__PURE__ */ new Map();
        let b = i;
      ...
      if (f != null)
        if (i < f && f < o) {
          let b = l, w = 1, C;
          for (; ++b < s && b < o && !((C = u.get(e[b])) == null || C !== f + w); )
            w++;
          if (w > f - i) {
            const K = e[l];
...
function xt(t, e = window.document) {
  ...
  for (let r = 0, s = t.length; r < s; r++) {
    const o = t[r];
    n.has(o) || (n.add(o), e.addEventListener(o, $t));
  }
}
function ft(t, e, n) {
...
function Tt(t, e, n) {
  ...
  for (o in e)
    s = e[o], s !== n[o] && (r.setProperty(o, s), n[o] = s);
  return n;
}
function E(t, e, n, r) {
  if (n !== void 0 && !r && (r = []), typeof e != "function") return D(t, e, r, n);
  R((s) => D(t, e(), s, n), r);
}
function $t(t) {
  let e = t.target;
  const n = `$$${t.type}`, r = t.target, s = t.currentTarget, o = (a) => Object.defineProperty(t, "target", {
    configurable: !0,
    value: a
  }), l = () => {
    const a = e[n];
...
function D(t, e, n, r, s) {
  ...
  if (t = l && n[0] && n[0].parentNode || t, o === "string" || o === "number") {
    ...
    if (l) {
      let i = n[0];
      i && i.nodeType === 3 ? i.data !== e && (i.data = e) : i = document.createTextNode(e), n = v(t, n, r, i);
    } else
    ...
    if (Array.isArray(e)) {
      ...
      if (H(i, e, n, s))
        return R(() => n = D(t, i, n, r, !0)), () => n;
      if (i.length === 0) {
        if (n = v(t, n, r), l) return n;
      } else a ? n.length === 0 ? Q(t, i, r) : Et(t, n, i) : (n && v(t), Q(t, i));
      n = i;
    } else if (e.nodeType) {
      if (Array.isArray(n)) {
...
function H(t, e, n, r) {
  ...
  for (let o = 0, l = e.length; o < l; o++) {
    ...
    if (!(i == null || i === !0 || i === !1)) if ((u = typeof i) == "object" && i.nodeType)
      ...
      if (r) {
        for (; typeof i == "function"; ) i = i();
        s = H(t, Array.isArray(i) ? i : [i], Array.isArray(a) ? a : [a]) || s;
      } else
        t.push(i), s = !0;
    else {
      const f = String(i);
  ...
  if (e.length) {
    ...
    for (let l = e.length - 1; l >= 0; l--) {
      ...
      if (s !== i) {
        ...
        !o && !l ? a ? t.replaceChild(s, i) : t.insertBefore(s, n) : a && i.remove();
      } else o = !0;
    }
...
function kt(t) {
  return Object.keys(t).reduce((n, r) => {
    const s = t[r];
    return n[r] = Object.assign({}, s), ht(s.value) && !jt(s.value) && !Array.isArray(s.value) && (n[r].value = Object.assign({}, s.value)), Array.isArray(s.value) && (n[r].value = s.value.slice(0)), n;
  }, {});
}
function Ot(t) {
  return t ? Object.keys(t).reduce((n, r) => {
    const s = t[r];
    return n[r] = ht(s) && "value" in s ? s : {
      value: s
    }, n[r].attribute || (n[r].attribute = Nt(r)), n[r].parse = "parse" in n[r] ? n[r].parse : typeof n[r].value != "string", n;
  }, {}) : {};
}
function Mt(t) {
...
function Pt(t, e) {
  ...
  return Object.keys(e).forEach((s) => {
    const o = n[s], l = t.getAttribute(o.attribute), i = t[s];
    l != null && (o.value = o.parse ? dt(l) : l), i != null && (o.value = Array.isArray(i) ? i.slice(0) : i), o.reflect && Y(t, o.attribute, o.value, !!o.parse), Object.defineProperty(t, s, {
      get() {
        return o.value;
      },
      set(a) {
        ...
        for (let f = 0, b = this.__propertyChangedCallbacks.length; f < b; f++)
          this.__propertyChangedCallbacks[f](s, a, u);
      },
      enumerable: !0,
      configurable: !0
    });
...
function Rt(t, e) {
  ...
  return class extends t {
    ...
    connectedCallback() {
      ...
      const s = Mt(this.props), o = this.Component, l = q;
      try {
        q = this, this.__initialized = !0, Bt(o) ? new o(s, {
          element: this
        }) : o(s, {
          element: this
        });
    ...
    attributeChangedCallback(s, o, l) {
      if (this.__initialized && !this.__updating[s] && (s = this.lookupProp(s), s in e)) {
        ...
        this[s] = e[s].parse ? dt(l) : l;
      }
    }
    lookupProp(s) {
      if (e)
        return n.find((o) => s === o || s === e[o].attribute);
    }
    get renderRoot() {
...
function It(t, e = {}, n = {}) {
  ...
  return (l) => {
    let i = o.get(t);
    return i ? (i.prototype.Component = l, i) : (i = Rt(r, Ot(e)), i.prototype.Component = l, i.prototype.registeredTag = t, o.define(t, i, s), i);
  };
}
function Dt(t) {
...
function Lt(t) {
  return (e, n) => {
    ...
    return Ct((s) => {
      const o = Dt(e);
      r.addPropertyChangedCallback((i, a) => o[i] = a), r.addReleaseCallback(() => {
...
`;
var Vt = /* @__PURE__ */ $("<div part=container class=dictate-button__container><style></style><button part=button class=dictate-button__button>"), qt = /* @__PURE__ */ $('<svg part=icon class="dictate-button__icon dictate-button__icon--idle"fill=none viewBox="0 0 24 24"stroke-width=1.5 stroke=currentColor><path stroke-linecap=round stroke-linejoin=round d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 0 1-3-3V4.5a3 3 0 1 1 6 0v8.25a3 3 0 0 1-3 3Z">'), zt = /* @__PURE__ */ $('<svg part=icon class="dictate-button__icon dictate-button__icon--recording"viewBox="0 0 24 24"fill=currentColor><path fill-rule=evenodd d="M4.5 7.5a3 3 0 0 1 3-3h9a3 3 0 0 1 3 3v9a3 3 0 0 1-3 3h-9a3 3 0 0 1-3-3v-9Z"clip-rule=evenodd>'), Ht = /* @__PURE__ */ $('<svg part=icon class="dictate-button__icon dictate-button__icon--processing"viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=1.5 stroke-linecap=round stroke-linejoin=round><path d="M12 2v4"></path><path d="m16.2 7.8 2.9-2.9"></path><path d="M18 12h4"></path><path d="m16.2 16.2 2.9 2.9"></path><path d="M12 18v4"></path><path d="m4.9 19.1 2.9-2.9"></path><path d="M2 12h4"></path><path d="m4.9 4.9 2.9 2.9">'), Gt = /* @__PURE__ */ $('<svg part=icon class="dictate-button__icon dictate-button__icon--error"fill=none viewBox="0 0 24 24"stroke-width=1.5 stroke=currentColor><path stroke-linecap=round stroke-linejoin=round d="M6 18 18 6M6 6l12 12">');
console.debug("dictate-button version:", "0.3.0");
const Wt = "https://api.dictate-button.io/transcribe", N = "dictate-button.io", z = -70, tt = -10, et = 0, Xt = 12, Zt = 0.25, Jt = 0.05;
Kt("dictate-button", {
  size: 24,
  apiEndpoint: Wt,
  language: void 0
  ...
  const K = (d) => d <= z ? 0 : d >= tt ? 1 : (d - z) / (tt - z), pt = (d) => {
    ...
    const _ = e.querySelector(".dictate-button__button");
    if (_) {
      const h = et + d * (Xt - et), c = 0.3 + d * 0.4;
      _.style.boxShadow = `0 0 0 ${h}px rgba(255,255,255,${c})`;
    }
  }, X = () => {
    if (!w || !f || !b) return;
    f.getByteTimeDomainData(b);
    const d = pt(b), _ = gt(d), h = K(_), c = h > C ? Zt : Jt;
    ...
    if (U(), o() === "idle")
      try {
        ...
        f = u.createAnalyser(), f.fftSize = 2048, _.connect(f), b = new Uint8Array(f.fftSize), i = new MediaRecorder(d, {
          ...
          w = !1, l("processing"), A(e, "transcribing:started", "Started transcribing");
          const h = new Blob(a, {
            type: "audio/webm"
          });
          try {
            const c = new FormData();
            c.append("audio", h, "recording.webm"), c.append("origin", window?.location?.origin), s && c.append("language", s);
            const k = await fetch(r, {
              method: "POST",
              body: c
            });
            if (!k.ok) throw new Error("Failed to transcribe audio");
            const O = await k.json();
            if (o() !== "processing") return;
            A(e, "transcribing:finished", O.text), l("idle");
          } catch (c) {
            console.error("Failed to transcribe audio:", c), A(e, "transcribing:failed", "Failed to transcribe audio"), Z();
          }
        }, i.start(), A(e, "recording:started", "Started recording"), w = !0, X(), l("recording");
      } catch (d) {
        console.error("Failed to start recording:", d), A(e, "recording:failed", "Failed to start recording"), Z();
      }
    else
      A(e, "recording:stopped", "Stopped recording"), l("idle"), U();
  }, Z = () => {
    l("error"), setTimeout(() => l("idle"), 2e3);
  };
  return (() => {
    var d = Vt(), _ = d.firstChild, h = _.nextSibling;
    return E(_, Ut), h.$$click = bt, E(h, (() => {
      var c = P(() => o() === "idle");
      return () => c() && M(Yt, {});
    })(), null), E(h, (() => {
      var c = P(() => o() === "recording");
      ...
      var c = P(() => o() === "processing");
      return () => c() && M(ee, {});
    })(), null), E(h, (() => {
      var c = P(() => o() === "error");
      return () => c() && M(ne, {});
    })(), null), R((c) => {
      var k = `width:${n}px;height:${n}px"`, O = Qt(o());
      return c.e = Tt(h, k, c.e), O !== c.t && ft(h, "title", c.t = O), c;
    }, {
      e: void 0,
      t: void 0
    }), d;
